const navigation = {
    ...
    main: [
      ...
      { name: 'Privacy', href: 'https://www.mindwellworld.com/privacy' },
      { name: 'Contact', href: 'mailto:support@mindwell.io' },
      { name: 'World', href: 'https://www.mindwellworld.com/' },
    ],

    // add or remove simple
    social: [
      {
        name: 'Instagram',
        href: '#',
      ...
      {
        name: 'GitHub',
        href: 'https://github.com/victorxtsai',
        icon: (props: React.SVGProps<SVGSVGElement>) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
    ...
    return (
      <footer className="bg-transparent">
        <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
          ...
          <p className="mt-10 text-center text-sm/6 text-gray-600">&copy; 2025 Mindwell World LLC. All rights reserved.</p>
        </div>
      </footer>
    )
  }
